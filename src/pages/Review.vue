...
function buildExportHTML() {
  ...
  p.questions.forEach((q, qi) => {
    ...
    // Student already has tick — no separate Answer line (as requested)
    const answerLine = ''
    ...
    html += `
      ...
      ${(qi+1) % 10 === 0 && qi !== p.questions.length - 1 ? `<div style="text-align:center; margin:8px 0 14px; padding:8px; font-size:10px; font-weight:700; letter-spacing:0.07em; text-transform:uppercase; color:#2F5FE0; background:#2F5FE00d; border:1px dashed #2F5FE030; border-radius:8px;">Generated by Rankify PDF2CBT — rankify-pdf2cbt.vercel.app — Free & Open Source</div>` : ''}
    `
  })
  ...
  // prominent footer at bottom of last content page
  html += `
    <div style="text-align:center; margin-top:22px; padding:10px; font-size:11px; font-weight:700; letter-spacing:0.06em; text-transform:uppercase; color:#2F5FE0; background:#2F5FE00d; border:1px solid #2F5FE030; border-radius:10px;">
      Generated by Rankify PDF2CBT — rankify-pdf2cbt.vercel.app — Free for every student
    </div>
  `
  // whole page branding at end — as requested: This pdf was made using Review Mode...
  html += `
    <div style="page-break-before:always; min-height:88vh; display:flex; flex-direction:column; justify-content:center; align-items:center; text-align:center; padding:36px 28px; margin-top:12px; border:3px solid #2F5FE0; border-radius:18px; background:#FBF8F1;">
      ...
      <div style="font-size:13px; font-weight:800; letter-spacing:0.06em; text-transform:uppercase; color:#2F5FE0; background:#2F5FE012; border:1px solid #2F5FE030; padding:4px 12px; border-radius:999px; margin-top:8px;">Review Mode</div>
      ...
      <p style="font-size:13px; line-height:1.65; color:#23203a; max-width:560px; margin:0 auto;">
        It is <b>free to use</b> and <b>open-source</b> for every student, teacher &amp; coaching — no signup, no upload to us, your PDFs stay private in your browser.<br/>
        Made for students, by a student <b style="color:#2F5FE0;">Naman</b> — because dead PDFs deserve to be live CBTs.<br/>
        <span style="display:inline-block; margin-top:10px; font-weight:700; color:#2F5FE0;">Go help someone by sharing this tool —</span> one share can save someone's 10 hours of re-typing. Thank you ❤️
      </p>
